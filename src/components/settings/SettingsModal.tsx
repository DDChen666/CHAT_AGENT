...
不要輸出任何 JSON 以外的內容。`
  ...
  const handleSave = () => {
    ...
    console.log('Saving settings:', { apiKeys, settings })
    onOpenChange(false)
  }
...
不要輸出任何 JSON 以外的內容。`
    ...
    setSystemPrompts(prev => ({
      ...prev,
      [promptType]: defaultPrompts[promptType]
    }))
  }
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) => setSystemPrompts(prev => ({ ...prev, improver: e.target.value }))}
                rows={8}
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) => setSystemPrompts(prev => ({ ...prev, critic: e.target.value }))}
                rows={8}
                className="w-full px-3 py-2 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary font-mono text-sm"
